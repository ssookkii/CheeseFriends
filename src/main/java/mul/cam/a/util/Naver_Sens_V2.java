...
public class Naver_Sens_V2 {
	...
	public void send_msg(String tel, String rand) {
        ...
        // 개인 인증키
        String accessKey = "iESy9zWmbQTj9BKgZX76";
        // 2차 인증을 위해 서비스마다 할당되는 service secret
        String secretKey = "rjQOzHcJM0OmsSfxxNNPI97SNzAocE5s13SLv8fC";
        // 프로젝트에 할당된 SMS 서비스 ID
        String serviceId = "ncp:sms:kr:306300157317:phone";
        // 요청 method
        String method = "POST";
